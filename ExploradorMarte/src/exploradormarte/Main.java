...
public class Main extends Game{
    ...
    public void initResources() {
        ...
        // Fondo del escenario
        backgnd = new ImageBackground(getImage("images/terrain-help.png"));
